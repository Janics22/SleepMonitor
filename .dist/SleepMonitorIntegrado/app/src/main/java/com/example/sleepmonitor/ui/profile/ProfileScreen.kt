        ...
        when (val current = state) {
            ...
            is ProfileState.Ready -> {
                ...
                Column(verticalArrangement = Arrangement.spacedBy(14.dp)) {
                    ...
                    ProfileCard(
                        title = "IA on-device integrada",
                        lines = listOf(
                            "El motor de analisis combina reglas locales con un modelo TFLite.",
                            "Los artefactos de IA viven tambien en la carpeta ml del repositorio.",
                            "La app ya registra feedback del usuario para seguir calibrando resultados."
                        )
                    )
                    OutlinedButton(
