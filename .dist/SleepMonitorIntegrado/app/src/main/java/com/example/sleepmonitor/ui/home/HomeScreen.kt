...
fun HomeScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = "La app mide tu descanso en local, genera un reporte y ahora integra un modelo TFLite on-device para apoyar la clasificacion de fases.",
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                InsightCard(
                    modifier = Modifier.weight(1f),
                    title = "IA integrada",
                    body = "El analisis combina reglas locales con un clasificador TFLite integrado en la app."
                )
            }
