...
class SleepSessionViewModel(
    ...
    fun recoverState() {
        viewModelScope.launch {
            ...
            val activeSession = sessionManager.getActiveSleepSessionAsync()
            if (activeSession != null) {
                ...
                sessionManager.clearActiveSleepSessionAsync()
            }
            ...
            _state.postValue(
                SleepSessionState.Ready(
                    showOnboarding = !sessionManager.hasSeenOnboardingAsync()
                )
            )
        }
    }
    ...
    fun dismissOnboarding() {
        ...
        viewModelScope.launch {
            sessionManager.setOnboardingSeenAsync()
        }
    }
    ...
    fun startSession(
        ...
        viewModelScope.launch {
            ...
            runCatching {
                ...
                sessionManager.saveActiveSleepSessionAsync(
                    sessionId = session.sessionId,
                    userId = userId,
